...
test('./calc "1-10+3 4"', 1, ['error'])
test('./calc "12*12*4*+4"', 1, ['error'])
test('./calc "4+12+-4/(1-1)"', 1,['error'])
test('./calc "51/(24 - (8*3)))"', 1, ['error'])
test('./calc "((((5 + 4))))"', 0, ['9'])
test('./calc "((-(4 + 0) + 4 )*20)"', 0, ['0'])
test('./calc "((((((((((1.3444))))))))))"', 0, ['1.3444'])
test('./calc "((((((((((1.3444))))))))))()"', 1, ['error'])